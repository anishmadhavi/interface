    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-green-100">
      <div className="text-center space-y-6">
        ...
        <div className="flex items-center justify-center space-x-3">
          ...
          <h1 className="text-4xl font-bold text-gray-900">Interface</h1>
        </div>
        ...
        <div className="flex gap-4 justify-center pt-4">
          <Link
            href="/login"
            className="px-6 py-3 bg-whatsapp text-white rounded-lg font-medium hover:bg-whatsapp-dark transition-colors"
          >
            Login
          </Link>
          <Link
        ...
        <p className="text-sm text-gray-500 pt-8">
          Version 0.1.0 • Built with Next.js & Supabase
        </p>
      </div>
    </div>
  );
